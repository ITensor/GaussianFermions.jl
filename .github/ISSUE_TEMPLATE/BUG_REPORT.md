---
name: GaussianFermions.jl bug report
about: Create a bug report to help us improve GaussianFermions.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("GaussianFermions")`:
```julia
julia> using Pkg; Pkg.status("GaussianFermions")
[YOUR OUTPUT HERE]
```
