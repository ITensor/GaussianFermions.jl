...
[![Coverage](https://codecov.io/gh/ITensor/GaussianFermions.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/ITensor/GaussianFermions.jl)
...
GaussianFermions.jl is supported by the Flatiron Institute, a division of the Simons Foundation.
...
```julia
julia> Pkg.add("GaussianFermions")
```
